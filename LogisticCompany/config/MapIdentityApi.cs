...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapAllIdentityApi<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : class, new()
    {
        ...
        ([FromBody] RegistrationData registration, HttpContext context, [FromServices] IServiceProvider sp,
            LogisticCompanyContext lcontext
        ) =>
        {
            ...
            if (!userManager.SupportsUserEmail)
                throw new NotSupportedException(
                    $"{nameof(MapAllIdentityApi)} requires a user store with email support.");
            ...
            var userNew = lcontext.ApplicationUsers.Single(u => u.Email == email);
            userNew.FirstName = firstName;
            userNew.LastName = lastName;
            userNew.BirthDate = birthDate;
        ...
        routeGroup.MapGet("/confirmEmail", async Task<Results<ContentHttpResult, UnauthorizedHttpResult>>
            ...
            .Add(endpointBuilder =>
            {
                ...
                confirmEmailEndpointName = $"{nameof(MapAllIdentityApi)}-{finalPattern}";
